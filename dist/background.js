...
---
${e}
---`}};chrome.runtime.onMessage.addListener((e,r,i)=>{if(e.action==="getAllSessions")return k().then(o=>{i(o)}).catch(o=>{i([])}),!0;if(e.action==="deleteSession")return R(e.id).then(()=>{i({success:!0})}).catch(o=>{i({success:!1})}),!0;if(e.action==="getBrainstormState")return i(t),!1;if(e.action==="stopBrainstorm")return t.active=!1,a("Stopped by user.","system"),u(),i({success:!0}),!0;if(e.action==="startBrainstorm")return(async()=>{P&&await S();const{topic:o,rounds:n,role:s,customGeminiPrompt:c,customChatGPTPrompt:d,geminiTabId:l,chatGPTTabId:b}=e;if(!l||!b){i({success:!1,error:"Missing tab IDs."});return}const I=crypto.randomUUID();t={active:!0,sessionId:I,prompt:o,role:s||"CRITIC",customGeminiPrompt:c,customChatGPTPrompt:d,rounds:n||3,currentRound:0,geminiTabId:l,chatGPTTabId:b,statusLog:[],isPaused:!1,humanFeedback:null},a(`Starting run: ${n} rounds...`,"system"),u();try{await $({id:I,topic:o,role:t.role,timestamp:Date.now(),transcript:[{agent:"User",text:o}]})}catch(f){a(`Failed to create DB session: ${f.message}`,"error")}v().catch(f=>{a(`Loop fatal error: ${f.message}`,"error"),t.active=!1,u()}),i({success:!0})})(),!0;if(e.action==="continueBrainstorm")return(async()=>{if(!t.geminiTabId||!t.chatGPTTabId){i({success:!1,error:"Tab IDs missing. Start a new run instead."});return}if(t.active){i({success:!1,error:"Run is already active."});return}const o=e.additionalRounds||2;t.rounds+=o,t.active=!0,a(`Continuing run for ${o} more rounds...`,"system"),u(),v().catch(n=>{a(`Loop fatal error: ${n.message}`,"error"),t.active=!1,u()}),i({success:!0})})(),!0;if(e.action==="generateConclusion")return(async()=>{if(!t.geminiTabId){i({success:!1,error:"Gemini tab ID missing."});return}if(t.active){i({success:!1,error:"Run is active. Please wait for it to finish."});return}t.active=!0,a("Generating Final Conclusion via Gemini...","system"),u();try{const o=`The debate is now over. Here is the final thought from your collaborator:
---
${t.prompt}
---
